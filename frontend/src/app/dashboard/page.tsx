      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-zinc-200">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3 text-xs text-zinc-600">
            <span>
              Target: <strong className="text-zinc-900 font-semibold">{candidate.targetRole}</strong>
            </span>
            <span className="w-1 h-1 rounded-full bg-zinc-300" />
            <span className="inline-flex items-center gap-1.5 font-mono text-zinc-600">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <Link
            href="/onboarding"
            className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-mono font-medium text-zinc-700 bg-white hover:bg-zinc-50 border border-zinc-200 transition-colors shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-6 flex flex-col justify-between hover:border-zinc-300 hover:shadow-md transition-all">
            ...
            <div className="pt-6">
              <Link
                href="/coding"
                className="w-full flex items-center justify-between px-4 py-2.5 rounded-lg text-xs font-semibold text-white bg-zinc-900 hover:bg-zinc-800 transition-colors shadow-sm"
              >
